          ...
          <div className="checkoutform">
            ...
            <div className="total-and-payment">
              <div>
                ...
                <div>
                  <span className="strong">{total.toFixed(2)}</span>
                  <i className="fas fa-euro-sign"></i>
                </div>
              </div>
              <p>
                Il ne vous reste plus qu'une étape pour vous offrir{' '}
                <span className="strong">{product_name}</span>. Vous allez payer{' '}
                <span className="strong">{total.toFixed(2)} euros</span>
            ...
            <div>
              <button className="button-payment" onClick={handleClick}>
                Pay
              </button>
            </div>
          </div>
